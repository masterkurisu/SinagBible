...
const FEATURE_LINES = [
  ...
  "Anchored to book, chapter & verse",
  "Attach photos",
  "Favorite & filter entries",
  "Search your journal",
...
type OnboardingSlide3Props = {
  onNext?: () => void;
  onBack?: () => void;
};

export function OnboardingSlide3({ onNext, onBack }: OnboardingSlide3Props) {
  ...
  return (
    ...
    >
      <View style={styles.centerBlock}>
        ...
        >
          <Text style={[styles.sectionLabel, { color: ui.brown600 }]}>{"JOURNAL & SEARCH"}</Text>
        </Animated.View>
        ...
        >
          <Text style={[styles.headline, { color: ui.brown800 }]}>Write. Reflect. Revisit.</Text>
        </Animated.View>
        ...
        >
          <Text style={[styles.description, { color: ui.tan300 }]}>
            Anchor your thoughts to Scripture, attach photos, and find anything instantly — across your Bible and
            your own entries.
          </Text>
        </Animated.View>
